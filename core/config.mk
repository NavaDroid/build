...
ifneq ($(NAVA_BUILD),)
include vendor/nava/config/BoardConfigNava.mk
endif
...
ifneq ($(NAVA_BUILD),)
ifneq ($(wildcard device/nava/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/nava/sepolicy/common/sepolicy.mk)
endif
endif
