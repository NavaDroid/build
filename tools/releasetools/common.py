...
class BlockDifference(object):
  ...
  def WriteScript(self, script, output_zip, progress=None,
    ...
    if not self.src:
      ...
      script.Print(" ")
      script.Print("Flashing NavaDroid %s partition..." % (self.partition,))
    else:
      script.Print(" ")
      script.Print("Flashing NavaDroid %s partition after verification." % (self.partition,))
  ...
  def WritePostInstallVerifyScript(self, script):
    partition = self.partition
    script.Print(" ")
    script.Print('Verifying NavaDroid %s files...' % (partition,))
    ...
    if self.tgt.extended:
      ...
      script.Print(" ")
      script.Print('Verified NavaDroid %s partition.' % (partition,))
      if partition == "system":
      ...
      script.Print(" ")
      script.Print('Verified NavaDroid %s files.' % (partition,))
